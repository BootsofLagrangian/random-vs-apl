...
_import_structure = {
    "scripts": ["init_zero_verbose", "ScriptArguments", "ActiveLearningArguments", "TrlParser"],
    "data_utils": [
        "apply_chat_template",
        "extract_prompt",
        "is_conversational",
...
if TYPE_CHECKING:
    ...
    from .scripts import ScriptArguments, ActiveLearningArguments, TrlParser, init_zero_verbose
    from .trainer import (
        AlignPropConfig,
        AlignPropTrainer,
        AllTrueJudge,
