...
_import_structure = {
    ...
    "erm_trainer": ["DebertaV2PairRM", "EnsembleRewardModel", "EnsembleRewardTrainer"],
...
if TYPE_CHECKING:
    ...
    from .erm_trainer import DebertaV2PairRM, EnsembleRewardModel, EnsembleRewardTrainer
